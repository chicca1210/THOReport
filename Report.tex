...
\begin{itemize}
	...
	\item Gestione delle operazioni sul DB
	\item Data Access Layer: Comunicazione con il DB per tutti i tipi di messaggi
	\item Gestione dei Marker sulla mappa dell'Organizer
\end{itemize}
...
La nostra scelta è stata, come indicato nel titolo, il motore MySQL.
